					...
					if($(this).data('icon') != undefined) {
					 ...
					 if($(this).data('type') != undefined) {
						...
						if(type == 'half') {
							...
							$(this).find('.circle-text-half').css({'line-height': (dimension /2) + 'px', 'font-size' : size + 'px' });
						} else {
							$(this).append('<span class="circle-text">' + icon + text + '</span>');
							$(this).find('.circle-text').css({'line-height': (dimension/1.2) + 'px', 'font-size' : size + 'px' });
						}
					} else {
						$(this).append('<span class="circle-text">' + icon + text + '</span>');
						$(this).find('.circle-text').css({'line-height': (dimension/2) + 'px', 'font-size' : size + 'px' });
					}
